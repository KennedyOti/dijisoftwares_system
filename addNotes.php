    ...
    ?>
        <div class="container-fluid p-0 mb-1 border-bottom">
            <nav class="navbar navbar-expand-lg bg-success navbar-light py-3 py-lg-0 px-lg-5">
                ...
                <h3 class="offset-2 text-white">Add Lecture Notes</h3>
            </nav>
        </div>
        ...
        <div class="container border">
            <div class="row m-2">
                ...
                <div class="col-6">
                    <div>
                        <label for="cname" class="form-label">Lesson Name</label>
                ...
                <div class="col-12">
                    <label for="cname" class="form-label">Meeting link </label>
                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            ...
                            <td><a href="<?php echo $c_data["description"]; ?>">Click to access Class Meeting</a></td>
