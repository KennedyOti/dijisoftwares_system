...
if(isset($_REQUEST['lessonSubmitBtn'])){
  ...
  if(($_REQUEST['lesson_name'] == "") || ($_REQUEST['lesson_desc'] == "") || ($_REQUEST['course_id'] == "") || ($_REQUEST['course_name'] == "") || ($_REQUEST['meeting_link'] == "")){
    ...
    $sql = "INSERT INTO lesson (lesson_name, lesson_desc, lesson_link, course_id, course_name, meeting_link) VALUES ('$lesson_name', '$lesson_desc','$link_folder', '$course_id', '$course_name', '$meeting_link')";
