...
<div class="container-fluid p-0 border-bottom">
        <nav class="navbar navbar-expand-lg bg-white navbar-light py-3 py-lg-0 px-lg-5">
            <a href="portal.php" class="navbar-brand ml-lg-3">
                <h1 class="m-0 text-uppercase text-success"><i class=" mr-3"></i>Dijisoftwares</h1>
            </a>
        </nav>
    </div>
            ...
            <div class="mt-4">
                <div class="main">
                    ...
                    <div class="d-grid gap-2 col-12 mx-auto">
                        <button class="btn btn-success" id="sbtn" onclick="stuLogin();"><i class="bi bi-person"></i> Log In</button>
                        <button class="btn btn-success d-none" id="tbtn" onclick="teaLogin();"><i class="bi bi-person-bounding-box"></i> Log In</button>
                    </div>
