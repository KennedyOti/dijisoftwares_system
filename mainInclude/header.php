...
<html lang="en">
  ...
  <body>
    ...
    <nav class="navbar navbar-expand-sm navbar-dark pl-5 fixed-top"  >
      <a href="portal.php" class="navbar-brand">Dijisoftwares</a>
      ...
      <div class="collapse navbar-collapse" id="myMenu">
        <ul class="navbar-nav pl-5 custom-nav">
          <li class="nav-item custom-nav-item"><a href="portal.php" class="nav-link">Home</a></li>
          ...
          <li class="nav-item custom-nav-item"><a href="#Contact" class="nav-link">Contact</a></li>
           <li class="nav-item custom-nav-item"><a href="index.php" class="nav-link">Visit Website</a></li>
           <?php 
              session_start();   
