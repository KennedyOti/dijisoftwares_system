                ...
                <div class="mt-4">
                    <div class="main">
                        ...
                        <div class="d-grid gap-2 col-12 mx-auto">
                            <button class="btn btn-success" id="sbtn" onclick="studentReg();"><i class="bi bi-person"></i> Sign Up</button>
                        </div>
            ...
            ?>
                ...
                <div class="mt-4">
                    <div class="main">
                        ...
                        <br>
                        <div class="d-grid gap-2 col-12 mx-auto">
                            <button class="btn btn-success" id="tbtn" onclick="teacherReg();"><i class="bi bi-person-bounding-box"></i> Sign Up</button>
                        </div>
